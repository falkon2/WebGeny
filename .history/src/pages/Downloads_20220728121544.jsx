              ...
              <div className='grid grid-cols-1 lg:grid-cols-3 lg:gap-3 justify-items-center mt-20 '>
                ...
                <div className='py-10 text-white   hover:scale-110 transition-[0.5s] '>
                  <div className=' overflow-hidden rounded-lg shadow-lg shadow-white bg-black  max-w-sm '>
                    ...
                    <a href="https://drive.google.com/file/d/1KXKA8l4gf2mVZX8FNpR-wp-4xVmdQbBv/view?usp=sharing"><button onClick={ComingSoon} className="bg-white  text-black w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-black hover:bg-black  hover:shadow-xl hover:shadow-white hover:text-white hover:scale-110">
                        Download
                      </button></a>
                    </div>
                  </div>
                ...
                <div className='py-10 text-white hover:scale-110 transition-[0.5s]'>
                  <div className='rounded-lg overflow-hidden  shadow-lg shadow-blue-500 bg-blue-500 max-w-sm'>
                    ...
                    <div className='justify-center items-center flex '>
                      <a href="https://drive.google.com/file/d/1EHkblBpWI5qzXR3mCTIYrCie72r7NP9_/view?usp=sharing"><button  className="bg-white  text-blue-600 w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-blue-700 hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-700 hover:text-blue-200 hover:scale-110">
                        Download
                      </button></a>
                    </div>
                  </div>
                ...
                <div className='py-10 text-black hover:scale-110 transition-[0.5s]'>
                  <div className='rounded-lg overflow-hidden shadow-lg max-w-sm shadow-white bg-white'>
                    ...
                    <div className='justify-center items-center flex '>
                    <a href="https://drive.google.com/drive/folders/1AqYDImkbqUQ4sjdD6LpsTR_H_IrQ2Sit?usp=sharing"><button onClick={ComingSoon}  className="bg-black  text-white w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-black hover:bg-black hover:shadow-xl hover:shadow-black hover:text-white hover:scale-110" >
                        Download
                      </button></a>
                    </div>
                  </div>
