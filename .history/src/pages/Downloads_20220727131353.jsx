              ...
              <div className='grid grid-cols-1 lg:grid-cols-3 lg:gap-3 justify-items-center mt-20 '>
                ...
                <div className='py-10 text-black hover:scale-110 transition-[0.5s]'>
                  <div className='rounded-lg overflow-hidden shadow-lg max-w-sm shadow-white bg-white'>
                    ...
                    <div className='justify-center items-center flex '>
                      <button  className="bg-black  text-white w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:black hover:bg-black hover:shadow-xl hover:shadow-black hover:text-white hover:scale-110" >
                        Download
                      </button>
                    </div>
                  </div>
