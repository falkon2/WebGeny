...
export default function Application() {
      ...
      case "content1":
        return (
          ...
          >
            ...
            <button onClick={} className="bg-white text-black w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-indigo-600 hover:bg-indigo-600  hover:shadow-xl hover:shadow-indigo-700 hover:text-white hover:scale-110">
              Download Now!
            </button>
          </div>
      </div>
  ...
  >
    ...
    {/* Button to switch to Content 3 */}
    <button onClick={() => setCurrentContent("content3")}>Content 3</button>

    {/* Render the appropriate content based on the current state value */}
    {getContent()}
