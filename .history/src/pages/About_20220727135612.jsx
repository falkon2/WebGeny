  ...
  return (
    ...
    <div className="text-white font-poppins">
        ...
        >
          ...
          <p className='md:text-xl sm:text-lg text-base'> This website builder was made using <a className="underline text-indigo-600">React</a>, <a className="underline text-indigo-600">Tauri</a> and <a className="underline text-indigo-600">Tailwind CSS</a>.</p>
          <Link to="/WebGeny"><button className="bg-white text-black w-[200px] transition-[0.5s] rounded-lg font-bold my-6 mx-auto py-3 ring-2 ring-white hover:ring-indigo-600 hover:bg-indigo-600  hover:shadow-xl hover:shadow-indigo-700 hover:text-white hover:scale-110">
            Home
          </button></Link>
        </div>
    </div>
