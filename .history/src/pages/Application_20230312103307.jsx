    ...
    switch (currentContent) {
      case "content1":
        return (
          ...
          <div className="text-white font-poppins overflow-none">
          <div
            id="index"
...
<div className="flex sticky z-10 justify-between items-center h-20 max-w-full mx-auto px-4 text-white font-poppins  top-0">
  ...
  const Footer = () => {
    return(
      <footer className="p-4 bg-white block rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-900 inset-x-0 bottom-0">
