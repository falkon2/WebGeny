    ...
    switch (currentContent) {
      case "content1":
        return (
          ...
          <div
            id="index"
            className="index max-w-[800px] mt-[-96px] w-full h-3/4 mx-auto text-center flex flex-col justify-center"
          >
...
<footer class="p-4 bg-white rounded-lg shadow inset-x-0 bottom-0 md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 overflow-hidden">
